...
public class ProductDao {
	...
	private final String INSERT_INTO_PRODUCT = "INSERT INTO product (user_id , product_name ,product_img ,category_id , product_status , description , postage , shipping_origin , shipping_method , price , exhibition_period , should_show , Registration_dete) VALUES (?,?,?,?,?,?,?,?,?,?,?,1,now())";
